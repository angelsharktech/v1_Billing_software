...
import { Visibility, Cancel, Print, Edit } from "@mui/icons-material";
...
const SaleBillList = () => {
  ...
  // Define the missing handleOpen function
  ...
  const handleView = async (billId) => {
    try {
      if (isMobile) {
        // Fetch bill data for mobile view
          ...
          <Grid item xs={12} sm={6}>
            ...
            >
              ...
              <Button
                ...
                fullWidth={isMobile}
              >
                {isMobile ? "Create Bill" : "Create Sale Bill (Alt + S)"}
              </Button>
            </Stack>
          </Grid>
        </Grid>
