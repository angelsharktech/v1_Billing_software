...
const PurchaseBillReturnReport = () => {
  ...
  const fetchBills = async () => {
    try {
      ...
      console.error("Failed to fetch purchase return bills:", err);
      setError("Failed to load purchase return bills");
    } finally {
      setLoading(false);
    }
  };
          ...
          <MenuItem
            onClick={() => {
              exportToPDF(
                mappedBills,
                exportColumns,
                `Purchase Return Report - ${gstFilter.toUpperCase() || "All"}`
              );
              handleExportClose();
            }}
          >
          ...
          <div className="p-4 border-b">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-orange-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600">Total Purchase Returns</p>
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600">Total Refund Received</p>
                <p className="text-2xl font-bold text-gray-800">
                  ₹{totalPaid.toFixed(2)}
                </p>
              </div>
                    ...
                    <TableRow>
                      ...
                      >
                        <div className="flex flex-col items-center justify-center text-gray-500">
                          ...
                          <p className="text-lg font-medium">No Purchase Return Bills Found</p>
...
export default PurchaseBillReturnReport;