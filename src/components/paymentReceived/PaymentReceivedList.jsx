...
// const PaymentReceivedList = ({ organizationId }) => {
...
//       const bills = data.data.filter((bill)=> bill.forPayment === 'sale')
//       setRows(bills || []);
//     } catch (error) {
...
const PaymentReceivedList = ({ organizationId }) => {
  ...
  const handlePaymentAdded = () => {
    refresh();
    setSnackbarMessage("Payment received added successfully!");
    setSnackbarOpen(true);
  };
  ...
  const totalAmount = filteredPayments?.reduce(
    (sum, payment) => sum + (payment.advanceAmount || payment.balance || 0),
    0
  );
      ...
      <div className="flex justify-between items-start mb-3">
        <div className="flex-1">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm font-medium px-2 py-1 rounded bg-green-50 text-green-700">
              ₹{Number(payment.advanceAmount > 0 ? payment.advanceAmount : payment.balance || 0).toFixed(2)}
            </span>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center text-sm text-gray-600">
              <span className="w-24 font-medium">Customer:</span>
              <span className="truncate">{payment.client_id?.name || 'N/A'}</span>
            </div>
            <div className="flex items-center text-sm text-gray-600">
              <span className="w-24 font-medium">Type:</span>
              <span className="capitalize">{payment.forPayment || 'sale'}</span>
            </div>
          </div>
        </div>
        <IconButton 
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <Button
              ...
              startIcon={<AddIcon />}
            >
              <span className="hidden sm:inline">Add Payment Received</span>
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Search by customer, payment mode, amount..."
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  ref={paymentReceivedInputRef}
                />
          ...
          <div className="block sm:hidden">
            {paginatedPayments?.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-lg font-medium text-gray-700 mb-2">No Payments Received</p>
                <p className="text-gray-500">Add your first payment received or adjust your search</p>
              </div>
            )}
          </div>
                ...
                <Table className="min-w-full">
                  <TableHead>
                    <TableRow className="bg-gray-50">
                      ...
                      <TableCell className="font-semibold text-gray-700 text-center">Customer Name</TableCell>
                        ...
                        <TableRow key={row._id} className="hover:bg-gray-50">
                          ...
                          <TableCell className="text-center">
                            <div className="font-bold text-lg text-green-600">
                              ₹{Number(row.advanceAmount > 0 ? row.advanceAmount : row.balance || 0).toFixed(2)}
                            </div>
                          </TableCell>
                          <TableCell className="text-center">
                            <IconButton 
                      ...
                      <TableRow>
                        <TableCell colSpan={6} className="text-center py-12">
                          <div className="flex flex-col items-center justify-center text-gray-500">
                            ...
                            <p className="text-sm">Add your first payment received using the "Add Payment" button</p>
                          </div>
                        </TableCell>
                      </TableRow>
                    )}
